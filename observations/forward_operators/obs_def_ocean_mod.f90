...
! POLY_ELECTRODE_OXYGEN,         QTY_DISSOLVED_OXYGEN,             COMMON_CODE
! TITRATION_ALKALINITY,          QTY_ALKALINITY,                   COMMON_CODE
! CATALYTIC_CARBON,              QTY_DISSOLVED_ORGANIC_CARBON,     COMMON_CODE
! UV_OXY_NITROGEN,               QTY_DISSOLVED_ORGANIC_NITROGEN,   COMMON_CODE
! CFA_NITRATE,                   QTY_NITRATE_CONCENTRATION,        COMMON_CODE
! CFA_SILICATE,                  QTY_DISSOLVED_INORGANIC_SIO3,     COMMON_CODE
! CFA_PHOSPHATE,                 QTY_PHOSPHATE_CONCENTRATION,      COMMON_CODE
